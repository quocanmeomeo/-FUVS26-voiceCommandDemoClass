...
// #include <DemoclassVoice_inferencing.h>
// // ---------------------------------------------------------------- //
...
// #define VERIFY_MIN_COUNT 2      // "More than 5" means > 5 (so 6, 7, etc.)
...
//         {
//             if (strcmp(current_label, "blue") == 0 || strcmp(current_label, "green") == 0)
//             {
...
//             float avgConf = 0;
//             if (matchCounter > 0)
//                 avgConf = matchConfidenceSum / matchCounter;
